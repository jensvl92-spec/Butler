...
export class HAWebSocket {
    ...
    constructor(url: string, token: string, onStateChange: (id: string, state: any) => void) {
        ...
        this.url = wsUrl
        this.token = token.trim().replace(/[^\x00-\x7F]/g, "")
    ...
    public sendMessage(payload: any): Promise<any> {
